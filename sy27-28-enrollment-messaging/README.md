...
- **30th Anniversary Site** (`campaigns/30th-anniversary-site/`) — inherits brand promise and 30th logo usage rules from this framework

## Status
Active. Time-sensitive. Building messaging executions on top of the marketing team framework.
